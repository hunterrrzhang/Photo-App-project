...
@app.route('/')
@decorators.jwt_or_login # decorator to ensure login before viewing the homescreen
def home():
    print("current user:")
    print(flask_jwt_extended.current_user.username)
    print(flask_jwt_extended.current_user.id)
